package com.mudxx.sso.oauth.domain;
...
public enum OauthResultCode implements IErrorCode {
     ...
     */
    INVALID_CLIENT(96003, "client_id 和client_secret不匹配"),
     ...
     */
    INVALID_TOKEN(96008, "access token 是错误的或已经过期"),


    /**
     * 用户密码不匹配
     */
    USERNAME_PASSWORD(96009, "用户密码不匹配"),
